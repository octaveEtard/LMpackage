function saveName = LM_save(data, saveName, saveFolder, overwrite, verbose)
% LM_save Save 'data' in file 'saveName', in folder 'saveFolder'.
%
...
[saveName,msg] = LM_saveSanityChecks(saveFolder,saveName,overwrite,verbose);
