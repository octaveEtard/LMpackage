function y = LM_laggedY(y,minLag,maxLag,iB,nx)
%
% LM_laggedY
...
% y_ = y(yb:ye,:)
%
% See also 'LM_laggedX which computes the corresponding matrix X, and
% 'LM_laggedXty' which efficiently computes Xty = X' * y_ through FFT
...
opt = LM_laggedDims(nx,iB,ny,minLag,maxLag);
y = y(opt.yb:opt.ye,:);
