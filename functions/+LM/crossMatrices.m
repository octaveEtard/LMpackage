function [XtX,Xty,mX,mY,N] = crossMatrices(stimOpt,EEGopt,opt,type)
%
% LM.crossMatrices
...
for iStimulus = 1:nStimLoad
    ...
    [iSlice,idx] = LM.idxSlice(sizeStim,sumFrom,iStimulus);
