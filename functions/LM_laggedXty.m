...
% See also:
%
%   LM_laggedXty to make Xty.
%
%   LM_laggedX & LM_laggedY to make the corresponding X and y matrices.
%
% ------ Example: -------
% N = 100;
...
if isYFFT
    ...
    [yF,mY,n_mY,Ytop,Ybottom] = LM_computeYFFT(y,minLag,maxLag,nFFT,opt);
end
