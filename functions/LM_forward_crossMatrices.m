function [XtX,Xty,mX,mY,N] = LM_forward_crossMatrices(stimOpt,EEGopt,opt)
%
    ...
    for iStimulus = 1:nStimPerFile
        ...
        if iSub == 1
            ...
            [XtX_,xF{iStimulus},mX(:,iStimulus),...
                Xtop{iStimulus},Xbottom{iStimulus},N(iStimulus)] = LM_laggedXtX(feature{iStimulus},minLag,maxLag,opt);
        ...
        [Xty_,mY(:,iStimulus,iSub)] = LM_laggedXty(xF{iStimulus},response,minLag,maxLag,...
