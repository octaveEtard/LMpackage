function X = LM_laggedX(x,minLag,maxLag,iB,ny)
%
% LM_laggedX
...
%
% See also 'LM_laggedY which computes the corresponding matrix Y, and
% 'LM_laggedXtX' which efficiently computes XtX = X' * X through FFT
...
opt = LM_laggedDims(nPnts,iB,ny,minLag,maxLag);
xb = opt.xb;
xe = opt.xe;
